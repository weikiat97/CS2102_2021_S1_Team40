...
export default function Navbar() {
  ...
  const authButton = user
    ? <Button className={classes.auth} variant="contained" onClick={() => dispatch(signoutUser())}>Logout</Button>
    : <div className={classes.auth}>
        <Button variant="contained" onClick={() => setLoginOpen(true)}>Login</Button>
        <Button variant="contained" onClick={() => setSignupOpen(true)}>Signup</Button>
      </div>;
